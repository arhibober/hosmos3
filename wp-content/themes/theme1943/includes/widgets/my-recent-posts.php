...
class MY_PostWidget extends WP_Widget {
  ...
  /** @see WP_Widget::widget */
						...
						<?php $wp_query = new WP_Query( $args ); ?>
								...
								<li class="clearfix">
									...
									<?php if(has_post_thumbnail()) { ?>
										...
										$image = aq_resize( $img_url, 132, 85, true ); //resize & crop img
										?>
										<figure class="image">
									...
									<?php } ?>
                  					...
                  					<strong><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to', 'theme1943');?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></strong>
    ...
    function form($instance) {				
      ...
      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Category Slug:', 'theme1943'); ?> <input class="widefat" id="<?php echo $this->get_field_id('category'); ?>" name="<?php echo $this->get_field_name('category'); ?>" type="text" value="<?php echo $category; ?>" /></label></p>
			
			<p><label for="<?php echo $this->get_field_id('post_format'); ?>"><?php _e('Post format:', 'theme1943'); ?><br />
      ...
      <p><label for="<?php echo $this->get_field_id('sort_by'); ?>"><?php _e('Post order:', 'theme1943'); ?><br />
