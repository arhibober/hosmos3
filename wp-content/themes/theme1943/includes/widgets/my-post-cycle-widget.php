...
class MY_CycleWidget extends WP_Widget {
    ...
    function widget($args, $instance) {		
        ...
        ?>
              ...
              <div id="testi-controls">
                <a href="#"><span id="prev-testi"><?php _e('Prev', 'theme1943'); ?></span></a> 
                <a href="#"><span id="next-testi"><?php _e('Next', 'theme1943'); ?></span></a>
                <ul id="nav-testi"></ul>
              </div>
							<!-- end of testimonials -->
						...
						<?php } else { ?>
							...
							<ul class="news">
								...
								<li>
									...
									<?php if($limittext!="" || $limittext!=0) : ?>
                                        <a href="<?php the_permalink(); ?>"><?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,$limittext); ?></a>
                                    <?php endif; ?>
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit Text:', 'theme1943'); ?> <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" /></label></p>
      <p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Posts per page:', 'theme1943'); ?><input class="widefat" style="width:30px; display:block; text-align:center" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>" type="text" value="<?php echo $count; ?>" /></label></p>

      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Type of posts:', 'theme1943'); ?><br />
      ...
      <p><label for="<?php echo $this->get_field_id('linktext'); ?>"><?php _e('Link Text:', 'theme1943'); ?> <input class="widefat" id="<?php echo $this->get_field_id('linktext'); ?>" name="<?php echo $this->get_field_name('linktext'); ?>" type="text" value="<?php echo $linktext; ?>" /></label></p>
			 
			 <p><label for="<?php echo $this->get_field_id('linkurl'); ?>"><?php _e('Link Url:', 'theme1943'); ?> <input class="widefat" id="<?php echo $this->get_field_id('linkurl'); ?>" name="<?php echo $this->get_field_name('linkurl'); ?>" type="text" value="<?php echo $linkurl; ?>" /></label></p>
